...
<div class="row">
	<div class="col-xs-12">
		<a href="<?php echo base_url()?>export_controller/export_company_appointments/<?php echo $general_id?>" class="btn btn-primary pull-right">Export</a>
	</div>
</div>
<div class="row">
	<div class="col-xs-12">
		...
		foreach($agendas as $agenda) {
			...
			<div class="search_result">
				<div class="info_section">
					...
					<div class="userinfo">
						<p class="name">
							<a href="<?php echo base_url()?>member/profile/view_profile/<?php echo $agenda['general_id']?>">
								<?php echo $agenda['trainer_detail']['name']?>
							</a>
						</p>
						<p class="cost">
							<label>Specialities:</label>
							<span><?php echo $user_specialites ?></span>
						</p>
						<p class="<?php echo $class;?>">
							<label>Appointment Date:</label>
							<span>
								<?php echo $agenda['appoint_date'] ?> <?php echo $agenda['start_event_time']?> to <?php echo $agenda['end_event_time']?>
							</span>
						</p>
					</div>
				</div>
				<div class="option_section clearfix">
					<div class="col-xs-12 option_section_wrapper">
						<p>
							<a class="contact_trainer_search_button" href="" id="contact" result="<?php echo $agenda['general_id'];?>" result_mail="<?php echo @$agenda['trainer_detail']['email_address'];?>"><i class="fa fa-comments"></i> Contact</a>
						</p>
						<p>

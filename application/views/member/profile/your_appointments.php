...
<div class="row">
	<div class="col-xs-12">
		<a href="<?php echo base_url()?>export_controller/export_trainer_appointments/<?php echo $general_id?>" class="btn btn-primary pull-right">Export</a>
	</div>
</div>
<div class="row">
	<div class="col-xs-12">
	...
	foreach($agendas as $agenda) {
		...
		$user_profile_image = getProfileImage($agenda['company_detail']);
	...
	?>
		<div class="search_result">
			<div class="info_section">
				...
				<div class="userinfo">
					<p class="name"><a href="<?php echo base_url()?>member/profile/view_profile/<?php echo $agenda['appointed_by']?>"><?php echo $agenda['company_detail']['name']?></a></p>
			...
			<div class="option_section clearfix">
				<div class="col-xs-12 option_section_wrapper">
					<p>
						<a class="contact_trainer_search_button" href="" id="contact" result="<?php echo $agenda['appointed_by'];?>" result_mail="<?php echo @$agenda['company_detail']['email_address'];?>"><i class="fa fa-comments"></i> Contact</a>
					</p>
					<p>
						<button class="agdBtn btn btn-xs btn-info" data-toggle="modal" data-target="#notificationModal" agenda_id="<?php echo @$agenda['id']?>">View Agenda</button>
					</p>
					<p><a href="<?php echo base_url()?>member/profile/view_profile/<?php echo $agenda['appointed_by']?>" class="btn">Visit Profile</a></p>
				</div>
			</div>
		</div>
	<?php } ?>

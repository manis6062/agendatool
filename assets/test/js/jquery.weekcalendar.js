...
//              calendarHeaderHtml+=    "</div>";
  ...
  TODO    if total height for an hour is less than 11px, there is a display problem.
      ...
      _renderEvent: function(calEvent, $weekDay) {
          ...
          var eventClass, eventHtml, $calEventList, $modifiedEvent,remove_id ,appointment_id ,appointed_by ,is_company ;

          eventClass = calEvent.id ? 'wc-cal-event' : 'wc-cal-event wc-new-cal-event';
          remove_id =  calEvent.id ?  calEvent.id:(eventData.events.length + 1);
         var appointment_id =  calEvent.appointment_id;

         var  appointed_by = calEvent.appointed_by;
          var is_company = calEvent.is_company;
          eventHtml = '<div class=\"' + eventClass + ' ui-corner-all\">';
          eventHtml +='<span class="remove" id = \"' + remove_id + '_' + appointment_id + '_' + appointed_by + '_' + is_company +'\"></span>';

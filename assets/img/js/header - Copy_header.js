$(document).ready(function(){
    ...
    $('#outlook_image').on('click',function(){
        $.ajax({
    ...
    $("#select_company").keydown(function (event) {
        ...
        .autocomplete({
            ...
            source: function (request, response) {
                $.getJSON(site_url+'member/profile/searchCompany'+'/'+$("#select_company").val(),{
    ...
    $('.contact_trainer_search_button').on('click',function(){
